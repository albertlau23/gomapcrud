...
class _NewsFeedScreenState extends State<NewsFeedScreen> {
            ...
            home: SafeArea(
              child: Scaffold(
                ...
                children: <Widget>[
                  ...
                  _singleNews(image: './assets/images/all/all-1.jpg',topic: "Business",author: "Johnnie N. Krug",date: "Jan 10, 2021",headline: "Tesla faces bumpier ride breaking into India",timeToRead: "5 min read"),
  ...
  _singleNews({String image,String topic,String headline,String author,String date, String timeToRead}){
      return InkWell(
        onTap: () {
          Navigator.push(
              context,
