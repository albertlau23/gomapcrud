        ...
        return MaterialApp(
            ...
            home: Scaffold(
              appBar: AppBar(
                centerTitle: true,
                elevation: 0,
                title: Text("Select Category",style: AppTheme.getTextStyle(themeData.textTheme.subtitle1,color: themeData.colorScheme.onBackground,fontWeight: 600,),),
              ),
                floatingActionButton: FloatingActionButton.extended(
                  ...
                  icon: Icon(MdiIcons.arrowRight,color: themeData.colorScheme.onPrimary,),
                ),
                body: Container(
      ...
      choices.add(Container(
        ...
        child: ChoiceChip(
          ...
          label: Row(
            ...
            children: [
              selectedChoices.contains(item) ? Icon(MdiIcons.check,size: MySize.size16,color: themeData.colorScheme.onPrimary,) : Container(),
              selectedChoices.contains(item) ? SizedBox(width: MySize.size8,) : Container(),
              Text(
                item,
